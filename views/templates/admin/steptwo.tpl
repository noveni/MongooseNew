	...
	<div class="col-lg-12">
		<div class="panel">
			...
			<div class="panel-footer">
				<button type="button" class="btn btn-default" id="transfert_mongoose_to_ps" data-url="{$link->getAdminLink('AdminMongooseImport',true)}"><i class="process-icon-download-alt"></i>{l s='Envoyer les produits sur la base'}</button>
			</div>
		</div>
		<div class="panel">
