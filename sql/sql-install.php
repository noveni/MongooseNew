...
// $sql['mongoose_supplier_config'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_supplier_config` (
...
$sql['mongoose_xml_file'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_xml_file` (
		`id_mongoose_xml_file` int(10) unsigned NOT NULL AUTO_INCREMENT,
		`src_file` varchar(255),
		`src_line_total` int(10),
		`src_current_line` int(10),
		`src_id_lang` int(10),
		PRIMARY KEY (`id_mongoose_xml_file`)
	) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8;';

//Create intermediate table for the products
$sql['mongoose_product'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_product` (
...
// $sql['mongoose_product_shop'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_product_shop` (
// 		`id_mongoose_product` int(10) unsigned NOT NULL AUTO_INCREMENT,
// 		`id_shop` int(10) unsigned NOT NULL,
// 		PRIMARY KEY (`id_mongoose_product`,`id_shop`)
// 	) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8;';
$sql['mongoose_product_lang'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_product_lang` (
		`id_mongoose_product` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
$sql['mongoose_category_product'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_category_product` (
...
$sql['mongoose_category'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_category` (
...
// $sql['mongoose_category_shop'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_category_shop` (
// 		`id_mongoose_category` int(10) unsigned NOT NULL AUTO_INCREMENT,
// 		`id_shop` int(10) unsigned NOT NULL,
// 		PRIMARY KEY (`id_mongoose_category`,`id_shop`)
// 	) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8;';
$sql['mongoose_category_lang'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_category_lang` (
		`id_mongoose_category` int(10) unsigned NOT NULL AUTO_INCREMENT,
		`id_lang` int(10) unsigned NOT NULL,
...
$sql['mongoose_manufacturer'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_manufacturer` (
		`id_mongoose_manufacturer` int(10) unsigned NOT NULL AUTO_INCREMENT,
		`id_manufacturer_supplier` int(10) NOT NULL,
		PRIMARY KEY (`id_mongoose_manufacturer`)
	) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8;';
// $sql['mongoose_manufacturer_shop'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_manufacturer_shop` (
// 		`id_mongoose_manufacturer` int(10) unsigned NOT NULL AUTO_INCREMENT,
// 		`id_shop` int(10) unsigned NOT NULL,
// 		PRIMARY KEY (`id_mongoose_manufacturer`,`id_shop`)
// 	) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8;';
$sql['mongoose_manufacturer_lang'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_manufacturer_lang` (
		`id_mongoose_manufacturer` int(10) unsigned NOT NULL AUTO_INCREMENT,
		`id_lang` int(10) unsigned NOT NULL,
		`title` varchar(255) NOT NULL,
...
// $sql['mongoose_attribute'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_attribute` (
...
// 	) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8;';
// $sql['mongoose_attribute_shop'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_attribute_shop` (
// 		`id_mongoose_attribute` int(10) unsigned NOT NULL AUTO_INCREMENT,
// 		`id_shop` int(10) NOT NULL,
// 		PRIMARY KEY (`id_mongoose_attribute`,`id_shop`)
// 	) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8;';
// $sql['mongoose_attribute_lang'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_attribute_lang` (
// 		`id_mongoose_attribute` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
// $sql['mongoose_attribute_group'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_attribute_group` (
...
// 	) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8;';
// $sql['mongoose_attribute_group_shop'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_attribute_group_shop` (
// 		`id_mongoose_attribute_group` int(10) unsigned NOT NULL AUTO_INCREMENT,
// 		`id_shop` int(10) unsigned NOT NULL,
// 		PRIMARY KEY (`id_mongoose_attribute_group`,`id_shop`)
// 	) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8;';
// $sql['mongoose_attribute_group_lang'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_attribute_group_lang` (
// 		`id_mongoose_attribute_group` int(10) unsigned NOT NULL AUTO_INCREMENT,
// 		`id_lang` int(10) unsigned NOT NULL,
...
$sql['mongoose_product_attribute'] = 'CREATE TABLE `'._DB_PREFIX_.'mongoose_product_attribute` (
